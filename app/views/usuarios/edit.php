<?php $title = "Editar Usuário - Administração"; ?>
<?php include __DIR__ . '/../layouts/header.php'; ?>

<h1 class="h3 mb-4 text-gray-800">✏️ Editar Usuário</h1>

<form action="index.php?r=usuarios/update" method="post" class="shadow-sm p-4 bg-white rounded">
